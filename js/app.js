...
function updateWaterUI() {
  ...
  const wrapH = g('waterWaveWrap')?.offsetHeight || 54;
  const risePx = (pct / 100) * wrapH;
  if (w1) w1.style.transform = `translate3d(0, ${-risePx}px, 0)`;
  if (w2) w2.style.transform = `translate3d(0, ${-risePx}px, 0)`;
